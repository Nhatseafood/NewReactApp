           ...
           <div className="container">
            <div class="jumbotron">
                    <h1>About Game World</h1>
                        <p>...</p>
                        <p><a class="btn btn-primary btn-lg" href="https://www.igdb.com/discover" role="button">Learn more</a></p>
                        </div>
                        <h3> This website was design to get database information on games from IGDB. Please click on Learn more to access API and information at IGDB.com.  </h3>
